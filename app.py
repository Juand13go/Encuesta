...
#         if password == 'juandiegojeronimo':  # Cambia esto a tu contraseña
...
# # from flask_mysqldb import MySQL
# # import MySQLdb.cursors
# # from generate_graphs import extract_data, plot_experiencia_general, plot_satisfaccion_atencion, plot_calidad_precio, plot_recomendacion
